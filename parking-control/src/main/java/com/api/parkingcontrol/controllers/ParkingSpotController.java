...
public class ParkingSpotController {
  ...
  public ParkingSpotController(ParkingSpotService parkingStopService) {
    this.parkingSpotService = parkingStopService;
  }
  ...
  // // .body("Conflict: Parking Spot already registered for this
  // apartment/block!");
  // // }
  // // insert vaga
  // // insert pessoa
  // // update vaga => id pessoa

  // /*
  // * insert carro
  // * insert pessoa => id carro
  // * insert vaga => id pessoa
  // */
  // var parkingSpotModel = new ParkingSpotModel();
  // BeanUtils.copyProperties(parkingSpotDto, parkingSpotModel);
  // parkingSpotModel.setRegistrationDate(LocalDateTime.now(ZoneId.of("UTC")));
  // return
  // ResponseEntity.status(HttpStatus.CREATED).body(parkingSpotService.save(parkingSpotModel));
  // }
